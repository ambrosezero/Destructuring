...
const [topStudent, ...theRest] = students;
...
function getWinner([first, second, third]) { return { first, second, third, } };
...
const { Ratings: [{ Value: imdbRating }, { Value: rtRating }, { Value: metaRating }], Versions: [{ runtime: movieLength }] } = movie;
